...
auth: SHA-256 HMAC, used by pilot.js to authenticate to superstar.
arduino_emulator.js: Processing implementation of Arduino calls.  delay() is handled with a chain of functions.
