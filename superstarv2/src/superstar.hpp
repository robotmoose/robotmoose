...
class superstar_t
{
	public:
		...
		void set(const std::string& path,const Json::Value& val,const Json::Value& auth);
		...
		void push(const std::string& path,const Json::Value& val,const Json::Value& len,const Json::Value& auth);
